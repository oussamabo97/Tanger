...
if ( ! function_exists( 'travel_joy_itinerary_get_template_part' ) ) {
	return;
}
...
<div id="main-content" class="wp-travel-archive-itinerary-wrapper">
	...
	if ( have_posts() ) :
		while ( have_posts() ) :
			the_post();
			travel_joy_itinerary_get_template_part( 'content', 'archive-itineraries' );
		endwhile; // end of the loop.
	else :
		travel_joy_itinerary_get_template_part( 'content', 'archive-itineraries-none' );
	endif;
