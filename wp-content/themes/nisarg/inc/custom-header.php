...
function nisarg_custom_header_setup() {
	...
	register_default_headers( array(
		'mountains' => array(
			...
			'thumbnail_url' => '%s/images/headers/mountains_thumbnail.jpg',
			'description'   => _x( 'food', 'header image description', 'nisarg' ),
		),
		'skyline' => array(
			'url'           => '%s/images/headers/skyline.jpg',
			'thumbnail_url' => '%s/images/headers/skyline_thumbnail.jpg',
			'description'   => _x( 'buildings', 'header image description', 'nisarg' ),
		),
		'sea' => array(
			'url'           => '%s/images/headers/sea.jpg',
			'thumbnail_url' => '%s/images/headers/sea_thumbnail.jpg',
			'description'   => _x( 'Wood', 'header image description', 'nisarg' ),
		),
		'food' => array(
			'url'           => '%s/images/headers/food.jpg',
			'thumbnail_url' => '%s/images/headers/food_thumbnail.jpg',
			'description'   => _x( 'food', 'header image description', 'nisarg' ),
		),
	) );
}
